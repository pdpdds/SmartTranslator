...
namespace SmartTran
{
    public class SmartGridUtil
    {
        ...
        public class SearchInfo
        {
            ...
            public SearchInfo(SmartGridUtil parent)
            {
                this.parent = parent;
                active = false;
                SameSearch = false;
            ...
            {
                if (parent.translationGrid.SelectedRows.Count == 0)
                {
                    return;
                }
        ...
        public SmartGridUtil(DataGridView translationGrid)
        {
